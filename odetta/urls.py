...
urlpatterns = patterns('',
    ...
    # adding odetta to get below
 
    url(r'^odetta/ajax/plot/(?P<model_id>\d+)/upload/$', upload),
    url(r'^odetta/ajax/plot/(?P<model_id>\d+)/(?P<time_step>\d+)/$', get_plot_data),
    url(r'^odetta/ajax/plot/(?P<model_id>\d+)/(?P<time_step>\d+)/(?P<mu_step>\d+)/$', get_plot_data),
    url(r'^odetta/ajax/plot/(?P<model_id>\d+)/(?P<time_step>\d+)/(?P<mu_step>\d+)/(?P<phi_step>\d+)/$', get_plot_data),
    url(r'^odetta/ajax/mu/(?P<model_id>\d+)/(?P<time_step>\d+)/(?P<phi_step>\d+)/$', batch_mu_data),
    url(r'^odetta/ajax/time/(?P<model_id>\d+)/(?P<mu_step>\d+)/(?P<phi_step>\d+)/$', batch_time_data),
    url(r'^odetta/ajax/overplot/(?P<model_id>\d+)/$', ajax_overplot),
    # url(r'^odetta/ajax/plot/(?P<id>\d+)/(?P<frame>\d+)/$', get_all_data),
