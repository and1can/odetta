...
FITS_ROOT = "/Users/tonywang/Documents/data/"
...
STATIC_ROOT = '/var/www/html/site_media/odetta/' #change if want to upload things (folder to upload)

# URL prefix for static files.
# Example: "http://example.com/static/", "http://static.example.com/"
STATIC_URL = '/site_media/odetta/'

#FORCE_SCRIPT_NAME = '/odetta' # uncomment when on NERSC
...
SECRET_KEY = 'yd&amp;t_ettta@=5e3@qwg(5+mpxxip$l51tz5ax+t^zkq=%(a$ew'
